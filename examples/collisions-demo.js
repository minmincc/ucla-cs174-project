...
export class Body {
    ...
    emplace(location_matrix, linear_velocity, angular_velocity, spin_axis = vec3(0, 0, 0).randomized(5).normalized()) {                               // emplace(): assign the body's initial values, or overwrite them.
...
export class Test_Data {
    ...
    constructor() {
        this.textures = {
            ...
            ground: new Texture("assets/background1.png"),
            gameOver: new Texture("assets/GameOver1.png"),
            forest: new Texture("assets/forest5.png"),
            background:new Texture("assets/background1.png"),
            basket:new Texture("assets/basket3.png"),
            fruit:new Texture("assets/fruitskin.png")
        }
        this.shapes = {
    ...
    random_shape(shape_list = this.shapes) {
        ...
        //return shape_list[shape_names[~~(shape_names.length * 2.0)]]
    }
}
...
export class Inertia_Demo extends Simulation {
    ...
    constructor() {
        ...
        this.material = new Material(shader, {
            color: color(0, 1, 0, 1),
            ambient: 0.5, texture: this.data.textures.grid
        })
    }

    random_color() {
        return this.material.override(color(1, 0.6 * Math.random(), 0 * Math.random(), 1));
    }
    ...
    update_state(dt) {
        ...
        while (this.bodies.length < 10)
            this.bodies.push(new Body(this.shapes.circle, this.random_color(), vec3(1, 1 , 1))
                .emplace(Mat4.translation(...vec3(0, 30, 0).randomized(10)),
